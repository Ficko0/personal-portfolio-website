    ...
    >
      <section className=" overflow-x-hidden group rounded-lg bg-gray-100 max-w-[42rem] border border-black/5 overflow-hidden sm:pr-8 relative sm:h-[20rem] hover:bg-gray-200 transition">
        ...
        <Image
          ...
          alt={title}
          quality={95}
          className="overflow-x-hidden absolute hidden sm:block top-8 -right-40 w-[28.25rem] transition rounded-t-lg shadow-2xl group-hover:-translate-x-3 group-hover:translate-y-3 group-hover:-rotate-2 group-hover:scale-[1.03]"
        />
      </section>
    </motion.div>
  );
